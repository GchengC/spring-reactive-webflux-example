...
public class SpringBootWebluxApplication implements CommandLineRunner {
    ...
    private static final Logger log = LoggerFactory.getLogger(SpringBootWebluxApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(SpringBootWebluxApplication.class, args);
    }
